...
public class VoitureApplication {
    ...
    CommandLineRunner initialiserBaseH2(VoitureRepository voitureRepository, ClientService clientService){
		return args -> {
			...
			System.out.println("**************************");
            voitureRepository.save(new Voiture(1L, "Toyota", "A 25 333", "Corolla", c2.getId()));
            voitureRepository.save(new Voiture(2L, "Renault", "B 6 3456", "Megane", c2.getId()));
            voitureRepository.save(new Voiture(3L, "Peugeot", "A 55 4444", "301", c1.getId()));
        };
	}
